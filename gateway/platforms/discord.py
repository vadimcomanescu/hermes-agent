...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Teseo session")
        ...
        @tree.command(name="status", description="Show Teseo session status")
        ...
        @tree.command(name="stop", description="Stop the running Teseo agent")
        ...
        @tree.command(name="update", description="Update Teseo Agent to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="thread", description="Create a new thread and start a Teseo session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Teseo in the thread",
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Teseo: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Teseo"
        if len(content) > 80:
